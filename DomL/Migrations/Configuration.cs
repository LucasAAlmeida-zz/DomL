    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DomLContext>
    {
        ...
        protected override void Seed(DomLContext context)
        {
            ...
            context.MediaType.AddOrUpdate(u => u.Id,
                ...
                new MediaType() { Id = 4, Name = "Master System", CategoryId = 14 },
                new MediaType() { Id = 5, Name = "Mega Drive", CategoryId = 14 },
                ...
                new MediaType() { Id = 11, Name = "Wii U", CategoryId = 14 },
                new MediaType() { Id = 12, Name = "Switch", CategoryId = 14 },
                new MediaType() { Id = 13, Name = "Game Boy", CategoryId = 14 },
                ...
                new MediaType() { Id = 26, Name = "Xbox", CategoryId = 14 },
                new MediaType() { Id = 27, Name = "Xbox 360", CategoryId = 14 },
                new MediaType() { Id = 28, Name = "Xbox One", CategoryId = 14 },
                new MediaType() { Id = 29, Name = "Xbox Series X", CategoryId = 14 },
                new MediaType() { Id = 34, Name = "Android", CategoryId = 14 },
                new MediaType() { Id = 35, Name = "Atari", CategoryId = 14 },
                ...
                new MediaType() { Id = 36, Name = "Tokusatsu", CategoryId = 15 }
            );
        }
    }
}
