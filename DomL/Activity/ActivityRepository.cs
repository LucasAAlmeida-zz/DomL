    ...
    public class ActivityRepository : DomLRepository<Activity>
    {
        ...
        private IOrderedQueryable<Activity> GetAllQueryableInclusive()
        {
            return DomLContext.Activity
                ...
                .Include(u => u.GameActivity.Game.Platform).Include(u => u.GameActivity.Game.Series).Include(u => u.GameActivity.Game.Director).Include(u => u.GameActivity.Game.Publisher).Include(u => u.GameActivity.Game.Score)
                .Include(u => u.GiftActivity)
                .Include(u => u.HealthActivity.Specialty)
                .Include(u => u.MovieActivity.Movie.Director).Include(u => u.MovieActivity.Movie.Series).Include(u => u.MovieActivity.Movie.Score)
                .Include(u => u.PetActivity.Pet)
                .Include(u => u.MeetActivity.Person)
                .Include(u => u.PlayActivity)
                .Include(u => u.PurchaseActivity.Store)
                .Include(u => u.ShowActivity.ShowSeason.Director).Include(u => u.ShowActivity.ShowSeason.Series).Include(u => u.ShowActivity.ShowSeason.Type).Include(u => u.ShowActivity.ShowSeason.Score)
